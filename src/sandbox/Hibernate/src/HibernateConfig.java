...
{
//create brand new project with main method. create database table, one hibernate entity to represent table, play with happy and nasty paths in main. Look for example on hibernate queries, inside main method do happy and nasty paths agains table.
